...
export default class MainView extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.downme = this.downme.bind(this)
    this.dropCancel = this.dropCancel.bind(this)
    this.dropInit = this.dropInit.bind(this)
  ...
  downme(){
    ...
    function toTop(){
      ...
      $(".circleButtonDiv").animate({
        ...
        easing: "swing",
        complete: function(){
          self.setState({ circle: "processing" });
          self.countDown();
        }
      });
    }
  ...
  dropCancel(){
    ...
    this.setState({ circle: 'drop' });
    $(".titleLetter")[0].innerHTML="One swipe to order!";
  }
  ...
  countDown(){
    ...
    this.setState({ counter: setInterval(timer, 1000) });
    function timer()
    {
      count=count-1;
      if (count <= 0)
      {
         clearInterval(self.state.counter);
         self.setState({ circle: "delivering" });
         $(".titleLetter")[0].innerHTML="Your order is on it's way!";
         return;
      }

      $(".titleLetter")[0].innerHTML="Swipe again within "+count+"s to cancel"; // watch for spelling
    }
  } 
  ...
  render() {
    //////dropbutton//////
    const currentCircle = this.state.circle;
    let circleDiv = null;
    let profileDivContent = null;
    ///////button change////////
    if(currentCircle == "drop"){
      circleDiv = <div  onClick={this.downme}>
              <img style={{height: '100'+'%'}} src="./images/Drop/main_slide_button.png"/>
              <div className="dropButtonLetter">DROP!</div>
            </div>
    }
    else if(currentCircle == "processing"){
      circleDiv = <div onClick={this.dropCancel}>
              <img style={{height: '100'+'%'}} src="./images/Drop/main_processing.png"/>
              <div className="processingLetter">PROCESSING</div>
            </div>
    }
    else if(currentCircle == "delivering"){
      circleDiv = <div onClick={this.dropInit}>
              <img style={{height: '100'+'%'}} src="./images/Drop/main_delivering.png"/>
              <div className="processingLetter">DELIVERING!</div>
            </div>
    }
    ///////profile disable////////
    if(currentCircle == "drop"){
      profileDivContent = <div className="profileDiv">
      ...
      profileDivContent = <div className="profileDiv">
              <div className="profileItemDiv">
                <img style={{float: 'left', height: '100'+'%'}} src="./images/Drop/main_time_icon_disabled.png"/>
                <div className="profileLetter">7:00pm - 9:00pm Today</div>
                </div>
              <div className="profileItemDiv">
                <img style={{float: 'left', height: '100'+'%'}} src="./images/Drop/main_delivery_icon_disabled.png"/>
                <div className="profileLetter">Duong Vung</div>
              </div>
              <div className="profileItemDiv">
                <img style={{float: 'left', height: '100'+'%'}} src="./images/Drop/main_location_icon_disabled.png"/>
                <div className="profileLetter">Home</div>
              </div>
              <div className="profileItemDiv">
                <img style={{float: 'left', height: '100'+'%'}} src="./images/Drop/main_shoppingcart_icon_disabled.png"/>
                <div className="profileLetter">150,000d for 13 items</div>
              </div>
            </div>
    }
